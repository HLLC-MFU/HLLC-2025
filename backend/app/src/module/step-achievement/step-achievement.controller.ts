...
export class StepAchievementController {
  constructor(private readonly stepAchievementService: StepAchievementService) { }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateStepAchievementDto: UpdateStepAchievementDto) {
