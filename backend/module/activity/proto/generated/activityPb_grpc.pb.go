...
const (
	...
	ActivityService_GetActivityByCode_FullMethodName = "/activity.ActivityService/GetActivityByCode"
...
type ActivityServiceClient interface {
	...
	GetActivityByCode(ctx context.Context, in *GetActivityByCodeRequest, opts ...grpc.CallOption) (*ActivityResponse, error)
...
func (c *activityServiceClient) GetActivityByCode(ctx context.Context, in *GetActivityByCodeRequest, opts ...grpc.CallOption) (*ActivityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ActivityResponse)
	err := c.cc.Invoke(ctx, ActivityService_GetActivityByCode_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ActivityServiceServer interface {
	...
	GetActivityByCode(context.Context, *GetActivityByCodeRequest) (*ActivityResponse, error)
...
func (UnimplementedActivityServiceServer) GetActivityByCode(context.Context, *GetActivityByCodeRequest) (*ActivityResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetActivityByCode not implemented")
}
...
func _ActivityService_GetActivityByCode_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetActivityByCodeRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ActivityServiceServer).GetActivityByCode(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ActivityService_GetActivityByCode_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ActivityServiceServer).GetActivityByCode(ctx, req.(*GetActivityByCodeRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ActivityService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ActivityService_GetActivityByCode_Handler,
		},
		{
	...
	Metadata: "module/activity/proto/activityPb.proto",
}
