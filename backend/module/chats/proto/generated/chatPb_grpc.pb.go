...
const (
	...
	RoomService_GetRoom_FullMethodName     = "/chat.RoomService/GetRoom"
	RoomService_ListRooms_FullMethodName   = "/chat.RoomService/ListRooms"
	RoomService_UpdateRoom_FullMethodName  = "/chat.RoomService/UpdateRoom"
	RoomService_DeleteRooms_FullMethodName = "/chat.RoomService/DeleteRooms"
)
...
type RoomServiceClient interface {
	...
	ListRooms(ctx context.Context, in *ListRoomRequest, opts ...grpc.CallOption) (*ListRoomResponse, error)
	UpdateRoom(ctx context.Context, in *UpdateRoomRequest, opts ...grpc.CallOption) (*RoomResponse, error)
	DeleteRooms(ctx context.Context, in *DeleteRoomRequest, opts ...grpc.CallOption) (*DeleteRoomResponse, error)
}
...
func (c *roomServiceClient) ListRooms(ctx context.Context, in *ListRoomRequest, opts ...grpc.CallOption) (*ListRoomResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (c *roomServiceClient) DeleteRooms(ctx context.Context, in *DeleteRoomRequest, opts ...grpc.CallOption) (*DeleteRoomResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeleteRoomResponse)
	err := c.cc.Invoke(ctx, RoomService_DeleteRooms_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RoomServiceServer interface {
	...
	ListRooms(context.Context, *ListRoomRequest) (*ListRoomResponse, error)
	UpdateRoom(context.Context, *UpdateRoomRequest) (*RoomResponse, error)
	DeleteRooms(context.Context, *DeleteRoomRequest) (*DeleteRoomResponse, error)
...
func (UnimplementedRoomServiceServer) ListRooms(context.Context, *ListRoomRequest) (*ListRoomResponse, error) {
...
func (UnimplementedRoomServiceServer) DeleteRooms(context.Context, *DeleteRoomRequest) (*DeleteRoomResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteRooms not implemented")
}
...
func _RoomService_ListRooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).ListRooms(ctx, req.(*ListRoomRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _RoomService_DeleteRooms_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteRoomRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoomServiceServer).DeleteRooms(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RoomService_DeleteRooms_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoomServiceServer).DeleteRooms(ctx, req.(*DeleteRoomRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RoomService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteRooms",
			Handler:    _RoomService_DeleteRooms_Handler,
		},
	},
