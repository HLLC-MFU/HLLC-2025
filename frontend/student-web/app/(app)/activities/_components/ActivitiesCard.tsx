...
export default function ActivitiesCard({ activity }: ActivitiesCardProps) {
    ...
    return (
        <div onClick={handleViewDetails} className="hover:cursor-pointer">
            <Card isHoverable className="min-h-full relative overflow-hidden border-white/20 border-2">
                <img
                        ...
                        <div className="flex justify-between items-center w-full">
                            ...
                            <div className="flex flex-col items-start min-w-0 text-start ml-1 w-full">
                                <div className="flex justify-between items-center w-full itme-center">
                                    ...
                                    <Chip color="default" variant="flat">
                                        <div className="flex items-center">
                                            <span className="text-xs truncate">{activity.metadata.isOpen ? 'Ready for Checkin' : 'Not Yet Open'}</span>
                                        </div>
                                    </Chip>
                                </div>
                                <p className="flex text-md font-semibold truncate w-full items-center">
                                ...
                                <p className="flex text-small truncate w-full items-center">
                                    <Clock size={15} /> {formatDateTime(activity.metadata.startAt)}
                                </p>
                            </div>
                        </div>
                    </CardBody>
