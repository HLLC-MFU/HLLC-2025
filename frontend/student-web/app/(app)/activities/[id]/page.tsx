...
export default function ActivitiesDetailPage() {
    ...
    useEffect(() => {
        ...
        const isCheckedIn = activity.checkinStatus === 2 || activity.checkinStatus === 3;
                ...
                <div className="min-h-screen flex flex-col gap-4">
                    ...
                    <div className="flex-col flex items-star mt-5 p-2">
                        <div className="flex justify-between w-full">
                            ...
                            <Card radius="md" className="w-[60px] h-[80px] items-center justify-center flex text-center">
                                <p className="text-sm p-2">{formatDateTime(activity?.metadata?.startAt)}</p>
                            </Card>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col items-center">
                        <div className="flex justify-between items-center w-full gap-2">
                            ...
                            <Chip
                                color={
                                    (activity?.checkinStatus === 2 || activity?.checkinStatus === 3) && activity?.hasAnsweredAssessment
                                        ? "success"
                                        : "danger"
                                }
                    ...
                    <div>
                        {activeTab === "about" ? (
                            <div className="flex flex-col gap-4">
                                ...
                                <EmbedMap lat={activity?.location.latitude} lng={activity?.location.longitude} />
                            </div>
                        ) : (
                            <div>
                                <Stepper steps={steps} direction="vertical" completedSteps={completedSteps} />
                            </div>
                        )}
                    </div>
                    {/* Assessment Modal */}
