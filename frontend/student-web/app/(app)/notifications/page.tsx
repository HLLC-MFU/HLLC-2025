            ...
            <div className="fixed inset-0 flex items-center justify-center bg-transparent px-4">
                <Card className="w-full max-w-xl py-6 px-6 bg-black/20 backdrop-blur-md border border-white rounded-2xl shadow-lg">
                    <div className="flex mb-4 p-1 bg-[#e1dedd] rounded-2xl w-full max-w-sm mx-auto">
                        <Button
                            className={`w-1/2 py-2 rounded-xl font-semibold text-sm transition-all duration-300 ${tab === "unread" ? "bg-black/60 text-white shadow-md" : "text-black"
                                }`}
                        ...
                        <Button
                            className={`w-1/2 py-2 rounded-xl font-semibold text-sm transition-all duration-300 ${tab === "read" ? "bg-black/60 text-white shadow-md" : "text-black"
                                }`}
                            onPress={() => setTab("read")}
                        >
                            Read
