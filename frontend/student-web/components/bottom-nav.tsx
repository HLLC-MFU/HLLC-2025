...
import { Home, QrCode, User, Settings, Book, Ticket, Globe } from 'lucide-react'; // Importing Lucide React icons
  ...
  navMenuItems: [
    {
      items: [
        ...
        { label: 'Activity', href: '/activity', icon: Book },
...
export default function BottomNav() {
  ...
  return (
    ...
    <div className="relative flex justify-center w-full">
      <nav className="flex justify-around items-center py-3 px-2 w-full max-w-md rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-lg">
        {navItems.map(item => {
          ...
          return (
            ...
            >
              ...
              <motion.div
                ...
                className="relative z-20 flex flex-col items-center" // Ensure icon and label are above the pill
