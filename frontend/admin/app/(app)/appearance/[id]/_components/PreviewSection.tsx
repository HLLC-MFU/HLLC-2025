...
export function PreviewSection({ appearance, colorDrafts }: PreviewSectionProps) {
    return (
        <Card className="shadow-xl hover:shadow-2xl transition-all duration-300 border-0 bg-white/70 backdrop-blur-sm">
            <CardHeader className="pb-4 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-t-lg">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-orange-100 text-sm">See how your colors look in action</p>
                    </div>
                </div>
            </CardHeader>
            <CardBody className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        <h3 className="font-semibold text-gray-700">Primary Color Usage</h3>
                    ...
                    <div className="space-y-4">
                        <h3 className="font-semibold text-gray-700">Secondary Color Usage</h3>
                        <div className="space-y-3">
                            <div 
                                className="p-4 rounded-lg text-white font-medium"
                ...
                <div className="mt-6 pt-6 border-t border-gray-200">
                    <h3 className="font-semibold text-gray-700 mb-3">Gradient Preview</h3>
                    <div 
