...
import { Accordion, AccordionItem, Button, Modal, ModalBody, ModalContent, ModalFooter, ModalHeader, Pagination } from "@heroui/react";
        ...
        <>
            ...
            <Modal backdrop="blur" isOpen={!!viewModalFlower} onClose={() => setViewModalFlower(null)} placement="center">
                <ModalContent className="max-w-md w-full">
                    ...
                    <ModalFooter>
                        <Button color="danger" variant="light" onPress={() => setViewModalFlower(null)}>Close</Button>
                    </ModalFooter>
                </ModalContent>
            </Modal>
        </>
