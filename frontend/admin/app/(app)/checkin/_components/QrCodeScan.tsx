...
const INITIAL_VISIBLE_COLUMNS = ["name","school", "major", "status" , "actions"];
      ...
      case "school":
        return (
          <div className="flex flex-col">
            ...
            <p className="text-bold text-tiny capitalize text-default-400">{user.school}</p>
          </div>
        );
      case "major":
        return (
          <div className="flex flex-col">
            <p className="text-bold text-small capitalize">{cellValue}</p>
            <p className="text-bold text-tiny capitalize text-default-400">{user.major}</p>
          </div>
        );
      case "status":
        return (
