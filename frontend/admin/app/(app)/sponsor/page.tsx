...
export default function SponsorPage() {
    ...
    const groupedSponsors: Record<string, Sponsor[]> = useMemo(() => {
        ...
        sponsor?.forEach((s) => {
            const type = typeof s.type === "object" ? s.type.name : s.type || "Unknown";
        ...
        <div className="flex flex-col min-h-screen">
            <div className="container mx-auto px-4">
                <div className="flex items-center justify-between mb-8">
                    ...
                    <Button color="primary" endContent={<Plus size={20} />} onPress={() => setIsTypeOpen(true)}>
                        New sponsor type
                    </Button>
                </div>
                    ...
                    {Object.entries(groupedSponsors).map(([type, sponsors]) => (
                        ...
                        >
                            <div className="flex flex-col gap-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-1  gap-4 py-6">
                                    <SponsorTable
                                        sponsors={filteredAndSortedSponsor}
